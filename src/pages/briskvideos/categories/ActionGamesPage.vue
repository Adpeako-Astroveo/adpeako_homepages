<template>
  <div class="action-games-page">
    <!-- Banner Section -->
    <section class="category-banner">
      <div class="banner-content">
        <div class="category-icon">🔥</div>
        <h1>Action Games</h1>
        <p>Fast-paced games full of excitement, combat, and adrenaline-pumping challenges</p>
      </div>
    </section>
    ...
    <section class="featured-section">
      <div class="section-container">
        <h2>Featured Action Games</h2>
        <div class="featured-slider">
          <div v-for="game in featuredActionGames" :key="game.id" class="featured-slide">
...
// Featured action games for slider
const featuredActionGames = ref([
  {
    id: 201,
    title: 'Battle Royale: Last Survivor',
    shortDescription: 'Survive against 99 other players in this intense battle royale game',
    image: 'https://images.pexels.com/photos/4009402/pexels-photo-4009402.jpeg'
  },
  {
    id: 202,
    title: 'Combat Evolved',
    shortDescription: 'Next-generation FPS with advanced AI and destructible environments',
    image: 'https://images.pexels.com/photos/442576/pexels-photo-442576.jpeg'
  },
  {
    id: 203,
    title: 'Warriors of the Night',
    shortDescription: 'Ninja-based action game with stealth mechanics and fluid combat',
...
.category-banner {
  ...
  background-image: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('https://images.pexels.com/photos/7915357/pexels-photo-7915357.jpeg');
}
