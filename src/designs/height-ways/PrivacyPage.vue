<template>
  <div class="privacy-page">
    <div class="privacy-container">
      ...
      <p class="last-updated">Last updated: March 15, 2023</p>

      <section>
        <h2>Introduction</h2>
        <p>Welcome to Height Ways. We respect your privacy and are committed to protecting your personal data. This Privacy Statement describes how your personal data is processed when using our mobile entertainment services and visiting our website.</p>
      </section>

      <section>
        <h2>Who We Are</h2>
        <p>Height Ways is operated by Berg Online Marketing B.V., which is also referred to as 'we', 'us', or 'our' in this privacy policy. We are responsible for processing your personal data when you visit our website or use our services.</p>
        <div class="contact-details">
          ...
          <p><strong>Email:</strong> privacy@height-ways.com</p>
        </div>
      </section>
      ...
      <section>
        ...
        <div class="contact-section">
          <p><strong>Email:</strong> dpo@height-ways.com</p>
