...
const entertainmentSections = ref([
  {
    ...
    description: 'Dive into millions of songs across every genre imaginable. From chart-topping hits to hidden indie gems, discover your next favorite track with crystal-clear sound quality.',
...
<template>
  <div class="mellow-lynx-homepage">
    <!-- Hero Section -->
    <section class="hero">
      <div class="hero-content">
        <h1>Your Entertainment,<br>Your Way</h1>
