  ...
  <div class="privacy-page">
    <div class="privacy-container">
      ...
      <section>
        ...
        <p>At Switch Runner, we are committed to protecting your privacy and ensuring your data is handled responsibly. This Privacy Policy outlines how we collect, use, disclose, and safeguard your information.</p>
      </section>
      ...
      <section>
        ...
        <div class="contact-details">
          ...
          <p><strong>Email:</strong> privacy@switch-runner.com</p>
        </div>
      </section>
...
.data-list, .usage-list, .security-measures, .legal-basis-list, 
.sharing-list, .transfer-list, .retention-list, .cookie-list {
  list-style: none;
  padding: 0;
  margin: 1rem 0;
}
...
.usage-list li, .security-measures li, .legal-basis-list li, 
.sharing-list li, .transfer-list li, .retention-list li, .cookie-list li {
  padding: 0.5rem 0 0.5rem 1.5rem;
  position: relative;
  color: #4a5568;
}

.usage-list li::before, .security-measures li::before, .legal-basis-list li::before,
.sharing-list li::before, .transfer-list li::before, .retention-list li::before, .cookie-list li::before {
  content: "•";
  color: #FF6347;
  position: absolute;
  left: 0;
